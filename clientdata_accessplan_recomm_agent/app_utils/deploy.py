...
@click.option(
    "--requirements-file",
    default="clientdata_accessplan_recomm_agent/app_utils/.requirements.txt",
    help="Path to requirements.txt file",
)
@click.option(
    "--env-file",
    default=None,
    help="Path to .env file for environment variables (defaults to clientdata_accessplan_recomm_agent/.env)",
)
@click.option(
    "--set-env-vars",
    default=None,
